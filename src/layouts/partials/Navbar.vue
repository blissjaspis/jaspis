<template>
  <div class="fixed inset-0 h-16 bg-black">
    <nav class="flex items-center justify-between flex-wrap container mx-auto px-4 md:px-2 sm:px-0 py-4 transition-all transition-500" 
      :class="{
      ...
      <div class="block flex-grow flex items-center w-auto">
        ...
        <div class="text-sm flex-grow uppercase">
          <ul class="list-none flex justify-left text-gray-300 uppercase transition-all transition-500">
            <li
              :key="element.name"
